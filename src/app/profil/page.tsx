...
import { BellIcon, HeartIcon, PlaneIcon, ArrowRightIcon } from "@/components/ui/icons"
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <Card className="mb-6 text-center p-8">
        <PlaneIcon className="h-12 w-12 text-primary mx-auto mb-4" />
        ...
        <div className="flex gap-3 justify-center">
          <Link href="/alerts">
            <Button variant="outline" className="gap-2">
              <BellIcon className="h-4 w-4" /> Preis-Alert erstellen
            </Button>
          </Link>
          <Link href="/fluege?from=DE">
            <Button className="gap-2">
              <PlaneIcon className="h-4 w-4" /> Flüge entdecken <ArrowRightIcon className="h-4 w-4" />
            </Button>
          </Link>
        </div>
      </Card>
