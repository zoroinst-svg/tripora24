...
import { FlameIcon, PlaneIcon, SpinnerIcon, SparklesIcon } from "@/components/ui/icons"
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        <div className="flex gap-2 overflow-x-auto pb-2">
          {(["all", "flight"] as const).map(t => (
            ...
            >
              {t === "all" ? "Alle" : <><PlaneIcon className="h-3 w-3" /> Flüge</>}
            </button>
          ))}
        </div>
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center">
          <FlameIcon className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
